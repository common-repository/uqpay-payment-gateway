...
return array(
	...
	'enabled'                       => array(
		...
		'label'       => __( 'Enable Alipay Online QR By UQPAY', 'uqpay-payment-gateway' ),
		'type'        => 'checkbox',
		'description' => '',
		'default'     => 'no',
	),
	'title'                         => array(
		...
		'default'     => __( 'Alipay Online QR (UQPAY)', 'uqpay-payment-gateway' ),
		'desc_tip'    => true,
	),
	'description'                   => array(
		...
		'default'     => __( 'You can pay by scan the Alipay QR through the Alipay APP', 'uqpay-payment-gateway' ),
		'desc_tip'    => true,
	),
