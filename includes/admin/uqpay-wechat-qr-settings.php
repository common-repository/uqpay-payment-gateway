...
return array(
	...
	'enabled'                       => array(
		...
		'label'       => __( 'Enable Wechat Online QR By UQPAY', 'uqpay-payment-gateway' ),
		'type'        => 'checkbox',
		'description' => '',
		'default'     => 'no',
	),
	'title'                         => array(
		...
		'default'     => __( 'Wechat Online QR (UQPAY)', 'uqpay-payment-gateway' ),
		'desc_tip'    => true,
	),
	'description'                   => array(
		...
		'default'     => __( 'You can pay by scan the Wechat QR through the Wechat APP', 'uqpay-payment-gateway' ),
		'desc_tip'    => true,
	),
